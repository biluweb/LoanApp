...
window.lCalendar2 = (function() {
    ...
    MobileCalendar.prototype = {
        init: function(params) {
            ...
            this.FinishEvent = params.FinishEvent;
            this.IsClear = false;
            if (params.IsClear) {
                this.IsClear = true;
            }
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                var ShowHtml = '<div class="date_ctrl slideInUp">' +
                    '<div class="date_btn_box">' +
                    '<div class="date_btn lcalendar_cancel">取消</div>';
                if (_self.IsClear) {
                    ShowHtml += '<div class="date_btn lcalendar_clear">清空</div>';
                }
                ShowHtml += '<div class="date_btn lcalendar_finish">确定</div>' +
                    '</div>' +
                    ...
                    '</div>' +
                    '</div>';
                _self.gearDate.innerHTML = ShowHtml;
                document.body.appendChild(_self.gearDate);
                dateCtrlInit();
                var lcalendar_clear = _self.gearDate.querySelector(".lcalendar_clear");
                if (lcalendar_clear != null) {
                    lcalendar_clear.addEventListener('touchstart', clearMobileCalendar);
                }
...
//              }
            ...
            //取消
            function clearMobileCalendar(e) {
                _self.trigger.value = "";
            ...
            function closeMobileCalendar(e) {
                ...
                $(".all-mechanism a").bind('tap', function(e) {
                    $(".all-mechanism a").unbind("tap");;
                });
            }
            //日期确认
...
//              date_dd=date_dd.replace(/\b(0+)/gi,"");
            ...
            _self.trigger.addEventListener('tap', {
                "date": popupDate,
                "datetime": popupDateTime,
                "time": popupTime,

            }[type]);
            _self.trigger.addEventListener('tap', function() {
